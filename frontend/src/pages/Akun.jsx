...
import EditProfileModal from "../components/fragments/EditProfileModal";
import AboutModal from "../components/fragments/AboutModal";
...
export default function Akun() {
  ...
  useEffect(() => {
    ...
    // Ensure dark mode is disabled (removed)
      ...
      <main className="flex-1 p-5 space-y-6 max-w-lg mx-auto w-full">
        ...
        <section className="bg-white dark:bg-slate-800 shadow-sm hover:shadow-md transition-shadow duration-200 rounded-2xl p-5 flex items-center gap-5 border border-gray-100 dark:border-slate-700/60">
          ...
          <div className="min-w-0">
            <h2 id="displayProfileName" className="text-xl font-bold truncate">
              {displayName}
            </h2>
            ...
            <ul className="bg-white dark:bg-slate-800 shadow-sm rounded-2xl overflow-hidden border border-gray-100 dark:border-slate-750 divide-y divide-gray-100 dark:divide-slate-750 transition-colors">
              ...
              >
                <div className="flex items-center justify-between p-4">
                  ...
                  <FontAwesomeIcon
                    icon={faChevronRight}
                    className="text-gray-300 dark:text-slate-600 text-xs group-hover:translate-x-0.5 transition-transform"
                  />
                </div>
              </li>
            ...
            <ul className="bg-white dark:bg-slate-800 shadow-sm rounded-2xl overflow-hidden border border-gray-100 dark:border-slate-750 divide-y divide-gray-100 dark:divide-slate-750 transition-colors">
              ...
              >
                <div className="flex items-center justify-between p-4">
                  ...
                  <FontAwesomeIcon
                    icon={faChevronRight}
                    className="text-gray-300 dark:text-slate-660 text-xs group-hover:translate-x-0.5 transition-transform"
                  />
                </div>
              </li>
