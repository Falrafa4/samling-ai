  ...
  return (
    <footer id="kontak" className="relative mt-24">
      ...
      <div className="bg-[#E6F4EA] border-t border-b border-emerald-100 py-16 relative overflow-hidden">
        ...
        <svg
          className="absolute right-10 bottom-0 h-36 opacity-10 text-emerald-800 pointer-events-none hidden md:block"
          viewBox="0 0 120 180"
          fill="currentColor"
        >
          ...
          <path
            d="M54 53 C54 48 57 42 60 35 C63 42 66 48 66 53 Z"
            fill="#EAB308"
          />
        </svg>
        ...
        <svg
          className="absolute left-10 bottom-0 h-36 opacity-10 text-emerald-800 pointer-events-none hidden md:block"
          viewBox="0 0 120 180"
          fill="currentColor"
        >
          ...
          <path
            d="M55 60 Q48 54 46 56"
            stroke="currentColor"
            strokeWidth="2"
            fill="none"
          />
          <path
            d="M65 60 Q72 54 74 56"
            stroke="currentColor"
            strokeWidth="2"
            fill="none"
          />
        ...
        <div className="container mx-auto px-6 max-w-7xl text-center relative z-10">
          <h2 className="text-3xl md:text-5xl font-bold mb-4 font-space tracking-wide text-[#064E3B]">
            SAVE OUR EARTH
          </h2>
          <p className="text-lg md:text-xl text-[#137333] max-w-2xl mx-auto font-bold">
            Bersama membangun Jakarta yang hijau dan berkelanjutan untuk
            generasi mendatang
          </p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12">
            ...
            <div>
              ...
              <p className="text-slate-600 mb-6 leading-relaxed font-medium">
                Solusi pengelolaan sampah pintar berbasis AI untuk Dinas
            ...
            {/* Stats */}
            <div>
              <h3 className="text-lg font-bold mb-6 text-slate-950 border-b border-slate-200 pb-2 inline-block">
              ...
              <ul className="space-y-4 text-slate-700">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-sm leading-relaxed text-slate-600 font-medium">
                    Grha Intirub Business Park, Jl. Cililitan Besar No. 454
                    Jakarta Timur
                  </span>
                </li>
